...
El febrer de 2025 va veure la llum el seu segon LP, LOS MALOS MUEREN, gravat, mesclat i masteritzat per Santi García als estudis Ultramarinos (Costa Brava) sota el segell discogràfic Subterfuge Records i amb el suport del segell Runaway Records.Aquest treball compta amb un seguici de cançons que segueixen una mateixa premissa: la de ser una mateixa.Un segon disc de peus ferms, reminiscència punk i melodies vocals que vaticinen alguns himnes generacionals i que marquen un nou ressorgiment a ple pulmó de la banda.`,
      es: `PELIGRO! es un trío de indie rock formado en Mallorca en 2018 por Esther Oller (voz y guitarra), Jordi Mulet (bajo y coros) y Miquel Marquet (batería).
La banda cuenta con un electrizante repertorio de canciones donde quedan claras sus influencias: rock alternativo en su vertiente más noventera.
Sus letras, cantadas en castellano, son sobre todo frescas y desenfadadas, con claras pinceladas de humor satírico.
En febrero de 2025 vio la luz su segundo LP, LOS MALOS MUEREN, grabado, mezclado y masterizado por Santi García en los estudios Ultramarinos (Costa Brava) bajo el sello Subterfuge Records y con el apoyo de Runaway Records.Este trabajo reúne una serie de canciones que siguen una misma premisa: la de ser una misma.Un segundo disco con paso firme, reminiscencias punk y melodías vocales que anticipan algunos himnos generacionales y marcan un nuevo resurgir de la banda.`,
      en: `PELIGRO! is an indie rock trio formed in Mallorca in 2018 by Esther Oller (vocals and guitar), Jordi Mulet (bass and backing vocals) and Miquel Marquet (drums).The band delivers an electrifying repertoire where their influences are clear: alternative rock in its most nineties-driven form.Their lyrics, sung in Spanish, are fresh and carefree, with touches of satirical humor.
In February 2025, they released their second LP, LOS MALOS MUEREN, recorded, mixed and mastered by Santi García at Ultramarinos studios (Costa Brava) under Subterfuge Records with support from Runaway Records.This work features a collection of songs built around the same idea: being oneself.
A second album with firm footing, punk reminiscences and vocal melodies that hint at generational anthems and mark a powerful resurgence for the band.`,
      fr: `PELIGRO! est un trio d’indie rock formé à Majorque en 2018 par Esther Oller (chant et guitare), Jordi Mulet (basse et chœurs) et Miquel Marquet (batterie).Le groupe propose un répertoire électrisant où leurs influences sont claires : un rock alternatif aux accents très années quatre-vingt-dix.Leurs paroles, chantées en espagnol, sont fraîches et décontractées, avec des touches d’humour satirique.
En février 2025, ils ont sorti leur deuxième LP, LOS MALOS MUEREN, enregistré, mixé et masterisé par Santi García aux studios Ultramarinos (Costa Brava) sous le label Subterfuge Records avec le soutien de Runaway Records.Cet album suit une même idée : rester fidèle à soi-même.Un second disque solide, aux réminiscences punk et aux mélodies vocales annonçant des hymnes générationnels et marquant un nouveau souffle pour le groupe.`,
    },
